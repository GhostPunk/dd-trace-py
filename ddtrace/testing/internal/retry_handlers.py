...
class AutoTestRetriesHandler(RetryHandler):
    def __init__(self, session_manager: "SessionManager") -> None:
        ...
        self.max_tests_to_retry_per_session = int(getenv("DD_CIVISIBILITY_TOTAL_FLAKY_RETRY_COUNT", "1000"))
        self.max_retries_per_test = int(getenv("DD_CIVISIBILITY_FLAKY_RETRY_COUNT", "5"))
