...
def _get_schema_version():
    version = getenv("DD_TRACE_SPAN_ATTRIBUTE_SCHEMA", default="v0")
...
_remove_client_service_names = asbool(getenv("DD_TRACE_REMOVE_INTEGRATION_SERVICE_NAMES_ENABLED", default=False))
