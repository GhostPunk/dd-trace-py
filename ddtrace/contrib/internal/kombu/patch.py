...
config._add(
    "kombu",
    {
        "distributed_tracing_enabled": asbool(getenv("DD_KOMBU_DISTRIBUTED_TRACING", default=True)),
        "service_name": config.service or getenv("DD_KOMBU_SERVICE_NAME", default=DEFAULT_SERVICE),
    },
)
...
def patch():
    ...
    # DEV: backwards-compatibility for users who set a kombu service
        ...
        prod_service = getenv("DD_KOMBU_SERVICE_NAME", default=DEFAULT_SERVICE)
